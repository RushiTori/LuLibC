...
#define EmptyBinaryNode (BinaryNode) { .left = NULL, .right = NULL, .key = 0, .data = NULL }
...
#define EmptyBinaryTree (BinaryTree) { .root = NULL, .dataSize = 0, .elementCount = 0, .containsPointers = false }
