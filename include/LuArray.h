...
#define DeclareArrayMethods(type, name)                                            \
	...
	bool name##EraseIfEqu(name* arr, const type data, __compar_fn_t func);         \
	...
	void name##Sort(name* arr, __compar_fn_t func);                                \
                                                                                   \
	bool name##Contains(const name* arr, const type data, __compar_fn_t func);     \
	size_t name##IndexOf(const name* arr, const type data, __compar_fn_t func);    \
	size_t name##LastIndexOf(const name* arr, const type data, __compar_fn_t func)
	...
	void name##Map(name* arr, void (*func)(type*)) {                                                    \
		for (size_t i = 0; i < arr->size; i++) {                                                        \
			func(arr->data + i);                                                                        \
                                                                                                        ...
                                                                                                        \
	void name##Sort(name* arr, __compar_fn_t func) { qsort(arr->data, arr->size, sizeof(type), func); } \
                                                                                                        \
	bool name##Contains(const name* arr, const type data, __compar_fn_t func) {                         \
		for (size_t i = 0; i < arr->size; i++) {                                                        \
